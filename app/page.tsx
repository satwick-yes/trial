...
export default function HomePage() {
  ...
  return (
    <div className="pb-20 bg-white dark:bg-[#0b1410]">
      <InteractiveHeroSection />
      
      <div className="space-y-16 sm:space-y-24 relative z-10 bg-white dark:bg-[#0b1410] rounded-t-[3rem] -mt-8 pt-8">
        ...
        <section className="relative px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="relative rounded-3xl sm:rounded-[2.75rem] bg-gradient-to-br from-[#e8f5e9]/70 via-[#ffffff] to-[#d8f3dc]/50 dark:from-[#112019] dark:via-[#0b1410] dark:to-[#183126] border border-[#d8e6df] dark:border-[#1f3d30] p-6 sm:p-12 lg:p-16 overflow-hidden shadow-xl">
            ...
            >
              ...
              <motion.div variants={staggerContainer} className="lg:col-span-7 space-y-6 sm:space-y-8 text-center lg:text-left">
                {/* Micro Pill Badge */}
                <motion.div variants={fadeUpVariant} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#1b4332]/10 dark:bg-[#52b788]/15 border border-[#1b4332]/20 dark:border-[#52b788]/30 text-[#1b4332] dark:text-[#52b788] text-xs font-black uppercase tracking-wider shadow-xs">
                  <Sparkles className="w-3.5 h-3.5 animate-spin" style={{ animationDuration: '4s' }} />
                  <span>100% Roasted Bihar Fox Nuts • Olive Oil Tossed</span>
                </motion.div>

                {/* Main Headline */}
                <motion.h1 variants={fadeUpVariant} className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-[#0f241d] dark:text-[#e8f5e9] leading-[1.08]">
                  CRUNCHY. <br />
                ...
                <motion.p variants={fadeUpVariant} className="text-base sm:text-lg text-[#406356] dark:text-[#749c8c] leading-relaxed max-w-xl mx-auto lg:mx-0 font-medium">
                ...
                <motion.div variants={staggerContainer} className="flex flex-wrap items-center justify-center lg:justify-start gap-2.5 sm:gap-3 text-xs font-bold text-[#0f241d] dark:text-[#e8f5e9]">
                  <motion.span variants={fadeUpVariant} className="px-3.5 py-2 rounded-2xl bg-white dark:bg-[#183126] border border-[#d8e6df] dark:border-[#1f3d30] flex items-center gap-2 shadow-xs transition-transform hover:-translate-y-1">
                ...
                <motion.div variants={fadeUpVariant} className="flex items-center justify-center lg:justify-start gap-4 pt-4 border-t border-[#d8e6df] dark:border-[#1f3d30]">
      ...
      <motion.section 
        initial="hidden" whileInView="visible" viewport={{ once: false, margin: "-50px" }} variants={staggerContainer}
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
          <div>
            ...
            <motion.h2 variants={fadeUpVariant} className="text-2xl sm:text-4xl font-black text-[#0f241d] dark:text-[#e8f5e9] tracking-tight">
      ...
      >
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
          <div>
            <motion.div variants={fadeUpVariant} className="text-xs font-black text-[#1b4332] dark:text-[#52b788] uppercase tracking-widest mb-1 flex items-center gap-1.5">
          ...
          <motion.div variants={fadeUpVariant} className="flex flex-wrap items-center gap-1.5 bg-[#e8f5e9]/70 dark:bg-[#183126] p-1.5 rounded-2xl border border-[#d8e6df] dark:border-[#1f3d30]">
            <button
          ...
          {filteredProducts.map((product) => {
            ...
            return (
              <motion.div variants={fadeUpVariant} key={product.id}>
                <div className="group rounded-3xl border border-[#d8e6df] dark:border-[#1f3d30] bg-white dark:bg-[#112019] hover:border-[#1b4332]/40 hover:shadow-xl card-hover-shadow flex flex-col justify-between overflow-hidden relative">
      ...
      <motion.section 
        ...
        className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
      >
        <motion.div variants={fadeUpVariant} className="text-center max-w-2xl mx-auto mb-12 space-y-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Bento Card 1 */}
          <motion.div variants={fadeUpVariant} className="relative rounded-3xl border border-[#d8e6df] dark:border-[#1f3d30] p-8 flex flex-col justify-between space-y-6 shadow-sm card-hover-shadow overflow-hidden group">
            <div className="absolute inset-0 bg-[#000000]">
              <video
                src="/assets/videos/Farmer_harvesting_lotus_seeds_1080p_20260912134827.mp4"
                autoPlay
                loop
                muted
                playsInline
          ...
          <motion.div variants={fadeUpVariant} className="relative rounded-3xl border border-[#d8e6df] dark:border-[#1f3d30] p-8 flex flex-col justify-between space-y-6 shadow-sm card-hover-shadow overflow-hidden group">
            <div className="absolute inset-0 bg-[#000000]">
              <video
                src="/assets/videos/Olive_oil_drizzling_on_nuts_20260912134820.mp4"
                autoPlay
                loop
                muted
                playsInline
          ...
          <motion.div variants={fadeUpVariant} className="relative rounded-3xl border border-[#d8e6df] dark:border-[#1f3d30] p-8 flex flex-col justify-between space-y-6 shadow-sm card-hover-shadow overflow-hidden group">
            <div className="absolute inset-0 bg-[#000000]">
              <video
                src="/assets/videos/Spicing_roasted_fox_nuts_1080p_20260912134842.mp4"
                autoPlay
                loop
                muted
                playsInline
      ...
      >
        <div className="rounded-3xl sm:rounded-[2.5rem] text-white p-8 sm:p-12 lg:p-16 relative overflow-hidden border border-[#2d6a4f]/60 shadow-2xl min-h-[400px] flex flex-col justify-center">
          ...
          <div className="absolute inset-0 z-0 bg-[#000000]">
            <video
              src="/assets/videos/Young_professional_eating_snack_1080p_20260912134831.mp4"
              autoPlay
              loop
              muted
              playsInline
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
          <div>
            <motion.div variants={fadeUpVariant} className="text-xs font-black text-[#1b4332] dark:text-[#52b788] uppercase tracking-widest mb-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {BLOG_POSTS.slice(0, 3).map((blog) => (
            <motion.div variants={fadeUpVariant} key={blog.id}>
              <Link
      ...
      >
        <motion.div variants={fadeUpVariant} className="text-center mb-10 space-y-2">
          <span className="text-xs font-black text-[#1b4332] dark:text-[#52b788] uppercase tracking-widest">
            SNACK CLARITY
          </span>
