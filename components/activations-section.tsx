...
const activations = [
  {
    icon: Building2,
    title: "Corporate Pantry",
    description: "Fuel your team with healthy Gustosa Fox Nuts.",
    cta: "Get Quote",
  },
  {
    icon: Sparkles,
    title: "Retail Partners",
    description: "Stock Gustosa products in your store or supermarket.",
    cta: "Become a Partner",
  },
  {
    icon: Dumbbell,
    title: "Gyms & Studios",
    description: "Offer a high-protein, guilt-free post-workout snack.",
    cta: "Contact Us",
  },
  {
    icon: Calendar,
    title: "Event Organizers",
    description: "Cater your next event with premium healthy snacks.",
    cta: "Sponsor Event",
  },
]
...
export function ActivationsSection() {
  ...
  return (
    <section id="bulk-order" className="relative py-16 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          >
            From corporate pantries to wholesale distributors, partner with Gustosa Foods.
          </motion.p>
        </motion.div>
