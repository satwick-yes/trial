...
const flavors = [
  {
    ...
    description: "Lightly salted with premium Himalayan pink salt for the perfect healthy crunch.",
    image: "/assets/makhana-2.jpg",
  ...
  },
  {
    ...
    description: "A cheesy, herby explosion of flavor that makes every bite irresistible.",
    image: "/assets/makhana-2.jpg",
  ...
  },
  {
    ...
    name: "Mystery Flavor",
    tagline: "Coming Soon",
    description: "Something deliciously epic is brewing... Stay tuned for our newest crunch.",
    image: "/assets/makhana-2.jpg",
...
export function FlavorCarousel() {
  ...
  return (
    <section id="shop" className="relative py-16 bg-white overflow-hidden">
      <motion.div
                  ...
                  <div className="grid md:grid-cols-2 gap-6 items-center">
                    ...
                    <div className="space-y-4">
                      ...
                      {!currentFlavor.mystery && (
                        ...
                        >
                          {["100% Natural", "High Protein", "Gluten Free", "Healthy Snack"].map((badge) => (
                            <span
                              key={badge}
