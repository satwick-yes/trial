...
const instagramPosts = [
  { image: "/assets/makhana-2.jpg", likes: "2.4k" },
  { image: "/assets/bulk.png", likes: "1.8k" },
  { image: "/assets/makhana-2.jpg", likes: "3.2k" },
  { image: "/assets/bulk.png", likes: "956" },
  { image: "/assets/makhana-2.jpg", likes: "1.5k" },
  { image: "/assets/bulk.png", likes: "2.1k" },
]
...
export function SocialSection() {
  ...
  return (
    <section id="blogs" className="relative py-16 bg-[#121212] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <motion.a
            href="https://instagram.com/gustosafoods"
            target="_blank"
          ...
          >
            ...
            <span className="relative z-10">Follow @gustosafoods</span>
          </motion.a>
        </motion.div>
      </div>
    </section>
